class GBufferRenderPass extends RenderPass {
    ...
    Render(engine, commandEncoder) {
        const renderPass = this.renderPass = commandEncoder.beginRenderPass({
            colorAttachments: [
                { view: this.screenPositionTexture.createView(), loadOp: "clear", storeOp: "store" },
                { view: this.screenNormalTexture.createView(), loadOp: "clear", storeOp: "store" },
                { view: this.screenTangentTexture.createView(), loadOp: "clear", storeOp: "store" },
                ...
                { view: this.emissionTexture.createView(), loadOp: "clear", storeOp: "store" },
                { view: this.pbrTexture.createView(), loadOp: "clear", storeOp: "store" },
