class Matrix4x4 extends Float32Array {
    ...
    static PerspectiveLH(fieldOfViewYInRadians, aspect, zNear, zFar, dst) {
        ...
        const f = 1.0 / Mathf.Tan(fieldOfViewYInRadians / 2.0);
        const range = zFar / (zFar - zNear);

        dst[0] = f / aspect; dst[1] = 0; dst[2] = 0; dst[3] = 0;
        dst[4] = 0; dst[5] = f; dst[6] = 0; dst[7] = 0;
        dst[8] = 0; dst[9] = 0; dst[10] = range; dst[11] = 1;
        dst[12] = 0; dst[13] = 0; dst[14] = -zNear * range; dst[15] = 0;
    ...
    static OrthoLH(left, right, bottom, top, near, far, dst) {
        ...
        dst[8] = 0; dst[9] = 0; dst[10] = 1 / (far - near); dst[11] = 0;
        dst[12] = (left + right) / (left - right);
        dst[13] = (top + bottom) / (bottom - top);
        dst[14] = -near / (far - near);
        dst[15] = 1;
    ...
    static Projection(width, height, depth, dst) {
        return Matrix4x4.OrthoLH(0, width, height, 0, 0, depth, dst);
    }
    ...
    static TRS(position, rotation, scale, dst = null) {
        ...
        dst[0] = r00 * sx; dst[1] = r10 * sx; dst[2] = r20 * sx; dst[3] = 0;
        dst[4] = r01 * sy; dst[5] = r11 * sy; dst[6] = r21 * sy; dst[7] = 0;
        dst[8] = r02 * sz; dst[9] = r12 * sz; dst[10] = r22 * sz; dst[11] = 0;
        dst[12] = position.x; dst[13] = position.y; dst[14] = position.z; dst[15] = 1;
    ...
    static Inverse(m, dst) {
        ...
        const tmp0 = m22 * m33; const tmp1 = m32 * m23;
        const tmp2 = m12 * m33; const tmp3 = m32 * m13;
        const tmp4 = m12 * m23; const tmp5 = m22 * m13;
        const tmp6 = m02 * m33; const tmp7 = m32 * m03;
        const tmp8 = m02 * m23; const tmp9 = m22 * m03;
        const tmp10 = m02 * m13; const tmp11 = m12 * m03;
        const tmp12 = m20 * m31; const tmp13 = m30 * m21;
        const tmp14 = m10 * m31; const tmp15 = m30 * m11;
        const tmp16 = m10 * m21; const tmp17 = m20 * m11;
        const tmp18 = m00 * m31; const tmp19 = m30 * m01;
        const tmp20 = m00 * m21; const tmp21 = m20 * m01;
        const tmp22 = m00 * m11; const tmp23 = m10 * m01;
    ...
    toJSON() {
        return {
            ...
            4: this[4], 5: this[5], 6: this[6], 7: this[7],
            8: this[8], 9: this[9], 10: this[10], 11: this[11],
            12: this[12], 13: this[13], 14: this[14], 15: this[15]
        };
    }
}