class VoxelGPU extends MonoBehaviour {
    ...
    Init() {
        ...
        this.verticesBuffer = new GraphicsBuffer(GPUBufferUsage.STORAGE | GPUBufferUsage.VERTEX | GPUBufferUsage.COPY_SRC, maxVertices, 16 * 4);
        this.indicesBuffer = new GraphicsBuffer(GPUBufferUsage.STORAGE | GPUBufferUsage.INDEX, maxVertices, 4, Uint32Array);

        this.verticesStagingBuffer = new GraphicsBuffer(GPUBufferUsage.COPY_DST | GPUBufferUsage.MAP_READ, maxVertices, 16 * 4);
    ...
    async GenerateMesh(voxelChunkComponent) {
        ...
        if (numVertices > 0) {
            ...
            const rawData = this.verticesStagingBuffer.GetMappedRange(0, numVertices * 16 * 4);
